...
## [0.2.2] - 2026-04-19
### Added
- Learning dropdown menu for dedicated educational purpose
- (Currently, only working feature is still lesson wizard)
- Recording browser for ease of access

## [0.2.1] - 2026-04-16
### Added
- Added a cute icon for the app.
- Fixed some small bugs relating to binary compilations.
